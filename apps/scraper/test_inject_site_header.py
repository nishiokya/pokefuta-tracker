...
<main>本文</main>
    ...
    def test_uses_relative_paths_for_nested_localized_page(self):
        ...
        self.assertIn('href="../../../gmanhole_map.html"><span class="site-header__label--desktop">Character Manholes</span><span class="site-header__label--mobile">Characters</span></a>', result)
        self.assertEqual(result.count('data-stamp-page="https://pokefuta.com/"'), 2)
        self.assertNotIn('data-profile-page=', result)
