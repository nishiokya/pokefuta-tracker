...
TAG_PAGE_COPY: dict[str, dict[str, str]] = {
    "roadside": {
        "h1": "道の駅・SAのポケふた",
        "lead": (
            "道の駅の敷地内（道の駅からおよそ50m以内を含む）と、高速道路のSA・PAや"
            "ハイウェイオアシスに設置されているポケふたです。"
            "駐車場とトイレが揃っているため、車での移動途中に立ち寄りやすいのが特徴です。"
        ),
        "description": (
            "道の駅・SAにあるポケふた{count}枚を都道府県別にまとめました。"
    ...
    "world_heritage": {
        "h1": "世界遺産のポケふた",
        "lead": (
            "世界遺産の構成資産がある市町村に設置されているポケふたです。"
            "観光の行き先としてもともと目的地になりやすく、ポケふた巡りと観光を1回の旅程にまとめられます。"
        ),
        "description": (
            "世界遺産のある市町村のポケふた{count}枚を都道府県別にまとめました。"
