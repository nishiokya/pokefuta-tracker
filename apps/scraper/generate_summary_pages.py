...
SUMMARY_STRINGS: dict[str, dict] = {
    "ja": {
        ...
        "discovery_hubs": {
            ...
            "travel": {"remote_island": "離島", "roadside": "道の駅・SA", "station_front": "駅前", "world_heritage": "世界遺産", "near_gundam_manhole": "ガンダムマンホールまで約500m以内", "gundam_manhole_city": "ガンダムマンホールのあるまち", "near_character_manhole": "キャラクターマンホールまで約1km以内", "character_manhole_city": "キャラクターマンホールのあるまち"},
    ...
    "en": {
        ...
        "map_base_href": "/en/",
        "page_title": "How Many Poké Lids Are There in Japan? Count & Rankings by Prefecture",
        "meta_desc": "Explore the total number of Poké Lids (Pokéfuta, Pokémon manhole covers) across Japan, the count by prefecture, top-ranking prefectures, and prefectures with none installed.",
        "breadcrumb_aria": "Breadcrumb",
        "nav_home_text": "Japan Map",
        "nav_home_href": "/en/",
        "h1": "How Many Poké Lids Are There in Japan?",
        "hero_title_lines": ("Poké Lids", "Data Map"),
        "hero_kicker": "Pokémon Manhole Data Guide",
        "subtitle": "Poké Lids (Pokéfuta) counted and sorted by prefecture from the latest dataset.",
        "stats_aria": "Nationwide Statistics",
        "stat_total": "Total Nationwide",
        "stat_installed": "Prefectures with Poké Lids",
        "stat_empty": "Prefectures with None",
        "total_fmt": "{count} Poké Lids",
        "total_fmt_one": "{count} Poké Lid",
        ...
        "empty_pref_fact": "This prefecture is still waiting for its first Poké Lid.",
        ...
        "h2_ranking": "Top Prefectures by Poké Lid Count",
        "h2_events": "Ongoing Events & Stamp Rallies",
        "event_ongoing": "Ongoing",
        "event_upcoming": "Starting soon",
        "ranking_note": 'Browse each prefecture\'s Poké Lids on the <a class="summary-link" href="/en/">Japan Map</a>.',
        "h2_regional": "Regional Distribution",
        "h2_empty": "Prefectures with No Poké Lids",
        "empty_note": 'Some prefectures don\'t have any Poké Lids yet. Future expansions are possible, and guessing "where will the next one appear?" is part of the fun.',
        "no_empty": "All prefectures currently have at least one Poké Lid.",
        "h2_map": "Explore on the Map",
        "map_desc": "Find Poké Lid locations and nearby manholes on the interactive map. Use the prefecture filter to plan your route.",
        "cta_text": "Explore all Poké Lids on the map →",
        "ai_intro": "There are {total} Poké Lids installed across Japan.",
        ...
        "ai_outro": "Poké Lids are deeply tied to regional tourism and local promotion, making travelling to collect them a beloved activity.",
        "disc_top_pct": "{pref} accounts for {pct}% nationwide",
        "disc_installed": "prefectures with Poké Lids",
        "disc_avg": "average per installed prefecture",
        "disc_empty": "prefectures still without Poké Lids",
        "region_names": {
        ...
        "regional_top2": "By region, {r1name} leads with {r1count} Poké Lids, followed by {r2name} ({r2count}).",
        "regional_top1": "By region, {r1name} has the most with {r1count} Poké Lids.",
        "regional_outro": "Poké Lids are often installed through partnerships with local governments and tourism associations, frequently found near tourist spots and train stations. Planning a multi-region route is a popular way to enjoy them.",
        "search_hub": {
            "h2": "Find Poké Lids",
        ...
        "popular_pokemon": {
            "h2": "Popular Pokémon on Poké Lids",
        },
        "discovery_hubs": {
            "travel_h2": "Explore by travel theme", "travel_note": "Choose your next Poké Lid destination by the kind of journey you want.",
            "rare_h2": "Find rare Poké Lids", "rare_note": "Discover one-of-a-kind Pokémon, Japan's four extremes, and remote locations.",
            "details": "View Poké Lids in this theme", "count": "{count} Poké Lids", "count_one": "{count} Poké Lid", "unique_count": "{count} Pokémon",
            "travel": {"remote_island": "Remote islands", "roadside": "Roadside stations & SAs", "station_front": "Train stations", "world_heritage": "World Heritage", "near_gundam_manhole": "Within about 500 m of a Gundam manhole", "gundam_manhole_city": "Municipalities with Gundam manholes", "near_character_manhole": "Within about 1 km of a character manhole", "character_manhole_city": "Municipalities with character manholes"},
            "rare": {"unique": "Pokémon found on only one Poké Lid", "extremes": "Japan's four extremes", "lone": "Remote and solitary"},
        },
        "pokemon_ranking": {
            "h2": "Pokémon Rankings",
            "h3_count": "By Poké Lid Count",
    ...
    "zh-CN": {
        ...
        "discovery_hubs": {
            ...
            "travel": {"remote_island": "离岛", "roadside": "道之驿・服务区", "station_front": "车站前", "world_heritage": "世界遗产", "near_gundam_manhole": "高达井盖约500米内", "gundam_manhole_city": "设有高达井盖的市町村", "near_character_manhole": "角色井盖约1公里内", "character_manhole_city": "设有角色井盖的市町村"},
    ...
    "zh-TW": {
        ...
        "discovery_hubs": {
            ...
            "travel": {"remote_island": "離島", "roadside": "道之驛・服務區", "station_front": "車站前", "world_heritage": "世界遺產", "near_gundam_manhole": "鋼彈人孔蓋約500公尺內", "gundam_manhole_city": "設有鋼彈人孔蓋的市町村", "near_character_manhole": "角色人孔蓋約1公里內", "character_manhole_city": "設有角色人孔蓋的市町村"},
    ...
    "ko": {
        ...
        "discovery_hubs": {
            ...
            "travel": {"remote_island": "외딴섬", "roadside": "미치노에키・휴게소", "station_front": "역 앞", "world_heritage": "세계유산", "near_gundam_manhole": "건담 맨홀 약 500m 이내", "gundam_manhole_city": "건담 맨홀이 있는 지자체", "near_character_manhole": "캐릭터 맨홀 약 1km 이내", "character_manhole_city": "캐릭터 맨홀이 있는 지자체"},
...
FACT_COPY: dict[str, dict] = {
    "ja": {
        ...
        "facts": {
            ...
            "first-pokefuta": {
                "type": "travel_trivia",
                "title": "ポケふた第1号は指宿市のイーブイ",
                "stat": "2018年12月",
                "main": "ポケふたの第1号は2018年12月20日、鹿児島県指宿市の指宿駅前に設置されたイーブイです。「いーぶいすき＝指宿（いぶすき）」の語呂合わせが縁で誕生しました。",
                "note": "今も指宿駅前で実際に見ることができます。",
                "share_title": "ポケふた第1号は2018年12月、指宿市のイーブイ。",
                "share_lead": "「いーぶいすき＝指宿」の語呂合わせがきっかけで生まれました。",
                "share_body": "今も指宿駅前で見ることができます。旅のついでに訪れてみてください。",
                "image_type": "summary_trivia",
                "image_title": "ポケふた第1号",
                "image_main_value": "2018年",
                "image_subtitle": "鹿児島県指宿市 指宿駅前",
                "image_footer": "日本初のポケモンマンホール",
                "map_pref": "鹿児島県",
            },
            "ibusuki-eevee-9": {
                "type": "travel_trivia",
                "title": "指宿市にイーブイ系が9枚揃う",
                "stat": "9枚",
                "main": "鹿児島県指宿市には、イーブイとその進化形8種類を合わせた9枚のポケふたがあります。市内を巡るだけでイーブイ系コンプリートができる唯一の場所です。",
                "note": "2019年2月に進化形8種が追加設置されました。",
                "share_title": "指宿市ではイーブイ進化系9枚が全部揃います。",
                "share_lead": "イーブイ＋進化形8種類が1つの市内に集結しているのはここだけ。",
                "share_body": "市内を歩いて全9枚を見つける旅は、ここでしかできません。",
                "image_type": "summary_trivia",
                "image_title": "イーブイ系9枚が指宿市に",
                "image_main_value": "9枚",
                "image_subtitle": "イーブイ＋進化形8種が集結",
    ...
    "en": {
        "daily": "Today's Poké Lid Trivia",
        "section": "Poké Lid Trivia",
        "share": "Share on X",
        "hashtags": ["#PokeLids", "#Pokefuta", "#PokemonManhole"],
        "empty_status": "{empty_count} prefectures still have none.",
        "empty_share_lead": "{empty_count} prefectures still have no Poké Lids.",
        "empty_image_subtitle": "{empty_count} still without one",
        "all_installed_status": "Every prefecture now has Poké Lids.",
        "all_installed_share_lead": "All prefectures now have Poké Lids.",
        ...
        "facts": {
            "hokkaido": {
                ...
                "stat": "{hokkaido}",
                "main": "{hokkaido_name} has {hokkaido} Poké Lids, about {hokkaido_pct}% of the nationwide total of {total}.",
                "note": "In wide-open Hokkaido, collecting Poké Lids can become a trip in itself.",
                "share_title": "{hokkaido_name} alone has {hokkaido} Poké Lids.",
                ...
                "image_footer": "Poké Lid ranking by prefecture",
                "map_pref": "北海道",
            },
            "installed-prefectures": {
                "type": "travel_trivia",
                "title": "{installed_count} prefectures have Poké Lids",
                "stat": "{installed_count}",
                "main": "Poké Lids are installed in {installed_count} prefectures. {empty_status}",
                "note": "They have spread across Japan, while a few blank spots remain.",
                "share_title": "Poké Lids are in {installed_count} prefectures.",
                "share_lead": "{empty_share_lead}",
                "share_body": "A nationwide list makes the next region to explore easier to spot.",
                "image_type": "summary_installed_prefectures",
                "image_title": "Prefectures with Poké Lids",
                "image_main_value": "{installed_count}",
                "image_subtitle": "{empty_image_subtitle}",
                "image_footer": "Nationwide Poké Lid list",
            },
            "tohoku": {
                "type": "regional_density",
                "title": "{tohoku_name}: {tohoku} in one region",
                "stat": "{tohoku}",
                "main": "{tohoku_name} has {tohoku} Poké Lids, one of the densest regions nationwide.",
                "note": "Fukushima, Miyagi, and Iwate make this area especially rewarding to explore.",
                "share_title": "{tohoku_name} has {tohoku} Poké Lids.",
                ...
                "image_footer": "Regional Poké Lid distribution",
            },
            "top-prefectures": {
                "type": "prefecture_rank",
                "title": "Top 3 prefectures",
                "stat": "TOP 3",
                "main": "The top 3 prefectures by Poké Lid count are {top3}.",
                "note": "Northern Japan has a strong presence near the top.",
                "share_title": "Top 3 prefectures by Poké Lid count.",
            ...
            "fukushima": {
                ...
                "stat": "{fukushima}",
                "main": "{fukushima_name} has {fukushima} Poké Lids, second only to Hokkaido.",
                "note": "A trip within the prefecture alone can be rich with discoveries.",
                "share_title": "{fukushima_name} has {fukushima} Poké Lids.",
                "share_lead": "That puts it second nationwide after Hokkaido.",
                "share_body": "It is enough for a full local Poké Lid trip.",
                "image_type": "summary_prefecture_rank",
            ...
            "mie": {
                ...
                "stat": "{mie}",
                "main": "{mie_name} has {mie} Poké Lids, giving it a clear presence in the Kinki-Tokai area.",
                "note": "It is easy to fold into a Kansai or Tokai travel plan.",
                "share_title": "{mie_name} has {mie} Poké Lids.",
            ...
            "first-pokefuta": {
                "type": "travel_trivia",
                "title": "The first Poké Lid: Ibusuki's Eevee",
                "stat": "Dec 2018",
                "main": "The very first Poké Lid was installed on December 20, 2018 in Ibusuki City, Kagoshima — featuring Eevee in front of Ibusuki Station. The name matched: 'I love Eevee (ii-bui-suki)' sounds just like 'Ibusuki'.",
                "note": "You can still see it today in front of Ibusuki Station.",
                "share_title": "The first Poké Lid was Eevee in Ibusuki City, December 2018.",
                "share_lead": "The name pun: 'ii-bui-suki' (I love Eevee) matches 'Ibusuki'.",
                "share_body": "It is still there in front of Ibusuki Station, and worth the trip.",
                "image_type": "summary_trivia",
                "image_title": "The First Poké Lid",
                "image_main_value": "2018",
                "image_subtitle": "Ibusuki City, Kagoshima",
                "image_footer": "Japan's first Pokémon manhole",
                "map_pref": "鹿児島県",
            },
            "ibusuki-eevee-9": {
                "type": "travel_trivia",
                "title": "9 Eevee-family Poké Lids in Ibusuki",
                "stat": "9",
                "main": "Ibusuki City has 9 Poké Lids covering Eevee and all 8 of its evolutions. It is the only city where you can find the whole Eevee family in one place.",
                "note": "The 8 evolutions were added in February 2019.",
                "share_title": "All 9 Eevee-family Poké Lids are in Ibusuki City.",
                "share_lead": "Eevee plus 8 evolutions — the full set in one city.",
                "share_body": "Walking the city to find all nine is a trip only Ibusuki can offer.",
                "image_type": "summary_trivia",
                "image_title": "9 Eevee-family in Ibusuki",
                "image_main_value": "9",
            ...
            "saga-nyansu": {
                ...
                "stat": "3",
                "main": "Saga City has 3 Poké Lids: Meowth, Alolan Meowth, and Galarian Meowth. All three feature balloon designs, fitting for a city famous for its hot air balloon festival.",
                ...
                "share_title": "All 3 Poké Lids in Saga City are Meowth variants.",
                ...
                "image_footer": "Poké Lids in Saga City",
                "map_pref": "佐賀県",
                "links": [
...
FACT_COPY["zh-CN"]["facts"] = {
    ...
    "first-pokefuta": {
        "type": "travel_trivia",
        "title": "第1号宝可梦井盖是指宿市的伊布",
        "stat": "2018年12月",
        "main": "第1号宝可梦井盖于2018年12月20日设置在鹿儿岛县指宿市指宿站前，图案为伊布。名称谐音「喜欢伊布」与指宿（いぶすき）读音相符。",
        "note": "现在在指宿站前仍可以看到。",
        "share_title": "第1号宝可梦井盖是2018年12月指宿市的伊布。",
        "share_lead": "谐音梗：「喜欢伊布」（いーぶいすき）与指宿（いぶすき）读音一致。",
        "share_body": "现在仍可在指宿站前看到，是一趟值得的旅行。",
        "image_type": "summary_trivia",
        "image_title": "第1号宝可梦井盖",
        "image_main_value": "2018年",
        "image_subtitle": "鹿儿岛县指宿市 指宿站前",
        "image_footer": "日本第一个宝可梦人孔蓋",
        "map_pref": "鹿児島県",
    },
    "ibusuki-eevee-9": {
        "type": "travel_trivia",
        "title": "指宿市集齐了伊布系9个井盖",
        "stat": "9个",
        "main": "鹿儿岛县指宿市有伊布及其8种进化形态，共9个宝可梦井盖。这是唯一一个可以在一座城市内集齐全部伊布系的地方。",
        "note": "8种进化形态于2019年2月追加设置。",
        "share_title": "指宿市可以找齐伊布系9个井盖。",
        "share_lead": "伊布＋8种进化形态，全部集中在同一个城市。",
        "share_body": "在市内步行寻找全部9个，是只有指宿才能体验的旅行。",
        "image_type": "summary_trivia",
        "image_title": "伊布系9个集中指宿市",
        "image_main_value": "9个",
        "image_subtitle": "伊布＋8种进化形态集结",
        "image_footer": "鹿儿岛县指宿市宝可梦井盖",
        "map_pref": "鹿児島県",
    },
}
FACT_COPY["zh-TW"]["facts"] = {
    ...
    "first-pokefuta": {
        "type": "travel_trivia",
        "title": "第1號寶可夢人孔蓋是指宿市的伊布",
        "stat": "2018年12月",
        "main": "第1號寶可夢人孔蓋於2018年12月20日設置於鹿兒島縣指宿市指宿站前，圖案為伊布。名稱諧音「喜歡伊布」與指宿（いぶすき）讀音相符。",
        "note": "現在在指宿站前仍可以看到。",
        "share_title": "第1號寶可夢人孔蓋是2018年12月指宿市的伊布。",
        "share_lead": "諧音梗：「喜歡伊布」（いーぶいすき）與指宿（いぶすき）讀音一致。",
        "share_body": "現在仍可在指宿站前看到，是一趟值得的旅行。",
        "image_type": "summary_trivia",
        "image_title": "第1號寶可夢人孔蓋",
        "image_main_value": "2018年",
        "image_subtitle": "鹿兒島縣指宿市 指宿站前",
        "image_footer": "日本第一個寶可夢人孔蓋",
        "map_pref": "鹿児島県",
    },
    "ibusuki-eevee-9": {
        "type": "travel_trivia",
        "title": "指宿市集齊了伊布系9個人孔蓋",
        "stat": "9個",
        "main": "鹿兒島縣指宿市有伊布及其8種進化形態，共9個寶可夢人孔蓋。這是唯一一個可以在一座城市內集齊全部伊布系的地方。",
        "note": "8種進化形態於2019年2月追加設置。",
        "share_title": "指宿市可以找齊伊布系9個人孔蓋。",
        "share_lead": "伊布＋8種進化形態，全部集中在同一個城市。",
        "share_body": "在市內步行尋找全部9個，是只有指宿才能體驗的旅行。",
        "image_type": "summary_trivia",
        "image_title": "伊布系9個集中指宿市",
        "image_main_value": "9個",
        "image_subtitle": "伊布＋8種進化形態集結",
        "image_footer": "鹿兒島縣指宿市寶可夢人孔蓋",
        "map_pref": "鹿児島県",
    },
}
FACT_COPY["ko"]["facts"] = {
    ...
    "first-pokefuta": {
        "type": "travel_trivia",
        "title": "포케후타 1호는 이부스키시의 이브이",
        "stat": "2018년 12월",
        "main": "포케후타 1호는 2018년 12월 20일, 가고시마현 이부스키시 이부스키역 앞에 설치된 이브이입니다. 「이브이 좋아(いーぶいすき)」와 「이부스키(いぶすき)」의 발음이 일치하는 데서 탄생했습니다.",
        "note": "지금도 이부스키역 앞에서 볼 수 있습니다.",
        "share_title": "포케후타 1호는 2018년 12월 이부스키시의 이브이.",
        "share_lead": "이름 말장난: 「이브이 좋아」와 「이부스키」 발음이 일치합니다.",
        "share_body": "지금도 이부스키역 앞에서 볼 수 있는, 여행할 가치가 있는 장소입니다.",
        "image_type": "summary_trivia",
        "image_title": "포케후타 1호",
        "image_main_value": "2018년",
        "image_subtitle": "가고시마현 이부스키시 이부스키역 앞",
        "image_footer": "일본 최초의 포켓몬 맨홀",
        "map_pref": "鹿児島県",
    },
    "ibusuki-eevee-9": {
        "type": "travel_trivia",
        "title": "이부스키시에 이브이 계열 9개 집결",
        "stat": "9개",
        "main": "가고시마현 이부스키시에는 이브이와 진화형 8종을 합한 9개의 포케후타가 있습니다. 하나의 도시에서 이브이 계열 전부를 찾을 수 있는 유일한 곳입니다.",
        "note": "진화형 8종은 2019년 2월에 추가 설치되었습니다.",
        "share_title": "이부스키시에서 이브이 계열 9개를 모두 찾을 수 있습니다.",
        "share_lead": "이브이＋진화형 8종이 하나의 도시에 집결.",
        "share_body": "시내를 걸으며 9개 전부를 찾는 여행은 이부스키에서만 가능합니다.",
        "image_type": "summary_trivia",
        "image_title": "이브이 계열 9개가 이부스키시에",
        "image_main_value": "9개",
        "image_subtitle": "이브이＋진화형 8종 집결",
        "image_footer": "가고시마현 이부스키시 포케후타",
        "map_pref": "鹿児島県",
    },
}
...
def _build_discovery_hub_sections(
    ...
    rare_cards = [
        ...
        card(copy["rare"]["extremes"], format_count(copy, "count", len(extreme_records)), extreme_records, "extremes"),
        card(copy["rare"]["lone"], format_count(copy, "count", len(lone_records)), lone_records, "lone"),
    ]
  ...
  <main class="summary-page">
    ...
    <header class="summary-hero">
      ...
      <div class="summary-hero-badge" aria-label="{escape(s['stats_aria'])}">
        ...
        <strong>{total}</strong>
        <small>{escape(format_count(s, 'total_fmt', total))} / {escape(s['installed_fmt'].format(count=len(installed)))}</small>
      </div>
    ...
    <section class="summary-stats" aria-label="{escape(s['stats_aria'])}">
      <div class="summary-stat">
        <span>{escape(s['stat_total'])}</span>
        <strong>{escape(format_count(s, 'total_fmt', total))}</strong>
      </div>
      <div class="summary-stat">
