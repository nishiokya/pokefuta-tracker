...
| 6 | 近くのデザインマンホール | 20km以内のガンダム蓋・キャラ蓋・写真館投稿（最大5件・距離付き）。写真館に投稿がある蓋は `pokefuta.com/design-manholes/{id}` へ直リンク＋写真、無い蓋は一覧へフォールバック＋「📷 写真募集中」 | 共通（tracker実装済み） | pokefuta.com は今後 |
